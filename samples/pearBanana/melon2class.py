...
class FruitConfig(Config):
    ...
    NUM_CLASSES = 1 + 2  # Background + strawberry + watermelon
...
class FruitDataset(utils.Dataset):
    ...
    def load_fruit(self, dataset_dir, subset):
        ...
        self.add_class("StrawberryMelon", 1, "strawberry")
        self.add_class("StrawberryMelon", 2, "watermelon")
        ...
        for a in annotations:
            ...
            if type(a['regions']) is dict:
                ...
                name_dict = {"strawberry": 1, "watermelon": 2}
