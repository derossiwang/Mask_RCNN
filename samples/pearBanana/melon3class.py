...
class FruitConfig(Config):
    ...
    NUM_CLASSES = 1 + 3  # Background + watermelon + strawberry-ripe + strawberry-nonripe
...
class FruitDataset(utils.Dataset):
    ...
    def load_fruit(self, dataset_dir, subset):
        ...
        self.add_class("StrawberryMelon", 1, "watermelon")
        self.add_class("StrawberryMelon", 2, "strawberry-ripe")
        self.add_class("StrawberryMelon", 3, "strawberry-nonripe")
        ...
        for a in annotations:
            ...
            if type(a['regions']) is dict:
                ...
                name_dict = {"watermelon": 1, "strawberry-ripe": 2, "strawberry-nonripe":3}
    ...
    def load_mask(self, image_id):
       ...
       Returns:
        ...
        if image_info["source"] != "StrawberryMelon":
    ...
    def image_reference(self, image_id):
        ...
        info = self.image_info[image_id]
        if info["source"] == "StrawberryMelon":
            return info["path"]
        else:
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='Train Mask R-CNN to detect StrawberryMelon.')
    parser.add_argument("command",
                        metavar="<command>",
                        help="'train' or 'splash'")
    parser.add_argument('--dataset', required=False,
                        metavar="/path/to/StrawberryMelon/dataset/",
                        help='Directory of the StrawberryMelon dataset')
