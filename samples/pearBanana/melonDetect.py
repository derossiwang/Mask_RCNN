...
COCO_MODEL_PATH = os.path.join(ROOT_DIR, "logs/strawberrymelon20200401T1713/mask_rcnn_strawberrymelon_0015.h5")

# Directory of images to run detection on
IMAGE_DIR = os.path.join(ROOT_DIR, "datasets/melon/test")
